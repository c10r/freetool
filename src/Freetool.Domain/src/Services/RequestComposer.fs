...
module RequestComposer =
    ...
    let composeExecutableRequest
        ...
        if appResourceId <> resourceId then
            ...
            // Get resource data
            let resourceBaseUrl = Resource.getBaseUrl resource
            ...
            let composedBaseUrl =
                ...
                | Some path ->
                    ...
                    if System.String.IsNullOrWhiteSpace(trimmedPath) then
                        trimmedBaseUrl
                    else
            ...
            let mergedUrlParameters =
                ...
                if not conflicts.IsEmpty then
                    ...
                    Error(InvalidOperation $"App cannot override existing Resource URL parameters: {conflictKeys}")
                else
